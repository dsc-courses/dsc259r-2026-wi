...
{:.no_toc}
## Checkpoint 1 Due Date: Monday, February 23rd, 2026 at 11:59PM PST
{:.no_toc}
## Checkpoint 2 Due Date: Monday, March 2nd, 2026 at 11:59PM PST
{:.no_toc}
## Final Due Date: Monday, March 16th, 2026 at 11:59PM PST <span style="color:red">(no extension allowed!)</span>
{:.no_toc}
...
The Final Project is worth 29% of your overall grade. This includes 4% for the two checkpoints (2% each), 5% for participation in project feedback, and 20% for the project deliverables. 
...
{: .green }
> **Final Project is due on Monday, March 16th, 2026 at 11:59PM PST. This is a hard deadline; you may NOT use the extension on this project.** This is because we need to start grading projects right when you turn them in, so that there is enough time for you to make regrade requests before we submit grades to campus. Note that we will not be able to hold many office hours during Finals Week, so make sure to start early.<br><br>
> The Final Project does also have two checkpoints, which are due on **Monday, February 23rd, 2026** and **Monday, March 2nd, 2026**. The Final Project Checkpoints are structured differently than other project checkpoints; rather than having you submit any code, you'll answer a few questions about your progress on the project. More details are in the [Checkpoint Submission](#submission-and-rubric) towards the bottom of this page. You can submit checkpoint 1 and checkpoint 2 on Gradescope; make sure to tag your partner if you have one.
...
1. Pull the latest version of the [`dsc259r-2026-wi`](https://github.com/dsc-courses/dsc259r-2026-wi/) repo. Within the `projects/proj04` folder, there is a `template.ipynb` notebook that you will use as a template for the project. If you delete the file or want another copy of the template, you can re-download it from [here](https://github.com/dsc-courses/dsc259r-2026-wi/blob/main/projects/proj04/template.ipynb). **This is where your analysis will live; you will submit this entire notebook to us.**
...
Your report will be in the form of a _static_ website, hosted for free on GitHub Pages. More specifically, you'll use [Jekyll](https://jekyllrb.com), a framework built into GitHub Pages that allows you to create professional-looking websites just by writing Markdown ([our course website](https://dsc-courses.github.io/dsc259r-2026-wi/) is built using Jekyll!). GitHub Pages does the "hard" part of converting your Markdown to HTML.
...
1. Create a new GitHub repository for your project.
   - GitHub Pages sites live at `<username>.github.io/<reponame>` (for instance, the site for [github.com/dsc-courses/dsc259r-2026-wi](https://github.com/dsc-courses/dsc259r-2026-wi) is [dsc-courses.github.io/dsc259r-2026-wi](https://dsc-courses.github.io/dsc259r-2026-wi)).
   - As such, **don't** include "DSC 259R" or "Final Project" in your repo's name – this looks unprofessional to future employers, and gives you a generic-sounding URL. Instead, mention that this is a project for DSC 259R at UCSD in the repository description.
...
As mentioned at the top of this page, this project **does** have two checkpoints, which are worth 4% of your overall grade (2% each). The first checkpoint is due on **Monday, February 23rd, 2026**. You can submit the checkpoint on Gradescope.
...
As mentioned at the top of this page, this project **does** have two checkpoints, which are worth 4% of your overall grade (2% each). The second checkpoint is due on **Monday, March 2nd, 2026**. You can submit the checkpoint on Gradescope.
